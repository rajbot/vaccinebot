...
counties = {
    ...
    "calaveras": County(name="Calaveras", url="https://covid19.calaverasgov.us/Vaccines"),
    "colusa": County(name="Colusa", url="https://www.countyofcolusa.org/771/COVID19"),
    "contracosta": County(name="Contra Costa", url="https://www.coronavirus.cchealth.org/vaccine"),
    "sanfrancisco": County(
