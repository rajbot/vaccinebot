...
def address_fixup(a):
    ...
    # wrong city
    a = a.replace('23850 Copper Hill Dr, Santa Clarita, CA 91354', '23850 Copper Hill Dr, Valencia, CA 91354')
    a = a.replace('7257 W Sunset Blvd, Los Angeles, CA 90046', '7257 W Sunset Blvd, West Hollywood, CA 90046')
    a = a.replace('19781 Rinaldi St, Porter Ranch, CA 91326', '19781 Rinaldi St, Northridge, CA 91326')
    a = a.replace('645 W 9th St, Los Angeles, CA 90015', '645 W 9th St, Los Angeles, CA 90017')
    a = a.replace('500 N Pacific Coast Hwy, El Segundo, CA 90245', '500 N Sepulveda Blvd, El Segundo, CA 90245')
    a = a.replace('7789 Foothill Blvd, Los Angeles, CA 91042', '7789 Foothill Blvd, Tujunga, CA 91042')
    a = a.replace('16830 San Fernando Mission Blvd, Los Angeles, CA 91344', '16830 San Fernando Mission Blvd, Granada Hills, CA 91344')
    return a
